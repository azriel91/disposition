...
use crate::{
    components::disposition_editor::editor_tab_bar::editor_tab_bar_theme_pages::EditorTabBarThemePages,
    editor_state::EditorPage,
};

#[component]
pub(crate) fn EditorTabBarTheme(active_page: Signal<EditorPage>) -> Element {
    rsx! {
        div {
            class: "
                flex
            ...
            EditorTabBarThemePages { active_page }
        }
    }
}
