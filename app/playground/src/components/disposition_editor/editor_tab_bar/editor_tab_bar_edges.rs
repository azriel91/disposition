...
use crate::{
    components::disposition_editor::editor_tab_bar::editor_tab_bar_edges_pages::EditorTabBarEdgesPages,
    editor_state::EditorPage,
};

#[component]
pub(crate) fn EditorTabBarEdges(active_page: Signal<EditorPage>) -> Element {
    rsx! {
        div {
            class: "
                flex
            ...
            EditorTabBarEdgesPages { active_page }
        }
    }
}
