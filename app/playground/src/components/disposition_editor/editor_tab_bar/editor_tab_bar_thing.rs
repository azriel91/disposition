...
use crate::{
    components::disposition_editor::editor_tab_bar::EditorTabBarThingPages,
    editor_state::EditorPage,
};

#[component]
pub(crate) fn EditorTabBarThing(active_page: Signal<EditorPage>) -> Element {
    rsx! {
        div {
            class: "
                flex
            ...
            EditorTabBarThingPages { active_page }
        }
    }
}
