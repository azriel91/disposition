//! Drag-and-drop border class helper for the thing layout page.
//!
//! Computes the Tailwind border-colour classes for a draggable row based on
//! whether it is currently the drop target. This is a copy of the helper in
//! the `things_page` module, kept separate so that the `thing_layout_page`
//! module tree is self-contained.
