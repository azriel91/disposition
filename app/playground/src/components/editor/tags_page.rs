...
use crate::components::editor::{
    common::{
        id_rename_in_input_diagram, parse_tag_id, parse_thing_id, RenameRefocus,
        RenameRefocusTarget, ADD_BTN, INPUT_CLASS, REMOVE_BTN, ROW_CLASS_SIMPLE, SECTION_HEADING,
    },
    datalists::list_ids,
